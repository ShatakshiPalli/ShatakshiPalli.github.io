      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          ...
          <p className="mb-8 text-gray-400">
            Interested in collaborating on ML projects or discussing opportunities? Let's connect and build something innovative together.
          </p>
          ...
          >
            <Button 
              ...
              onClick={() => {
                ...
                window.open('/shatakshi-palli-cv.pdf', '_blank')
              }}
            >
              📄 Download CV
            </Button>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8 text-center">
            <div className="space-y-2">
              ...
              <p className="text-white">shatakshi.palli@email.com</p>
            </div>
            <div className="space-y-2">
              <div className="text-2xl">💼</div>
              <p className="text-gray-400">LinkedIn</p>
              <p className="text-white">linkedin.com/in/shatakshi-palli</p>
            </div>
            <div className="space-y-2">
              <div className="text-2xl">🐙</div>
              <p className="text-gray-400">GitHub</p>
              <p className="text-white">github.com/shatakshi-palli</p>
            </div>
          </div>
        </motion.div>
        <motion.div
