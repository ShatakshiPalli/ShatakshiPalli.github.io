  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
        ...
        <motion.p
          className="max-w-[600px] text-xl text-gray-400 sm:text-2xl lg:text-3xl"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <button
            ...
            className="px-8 py-3 border border-gray-400 text-gray-300 rounded-lg font-medium hover:bg-gray-800 hover:border-gray-300 transition-all"
          >
            Download CV
          </button>
        </motion.div>
